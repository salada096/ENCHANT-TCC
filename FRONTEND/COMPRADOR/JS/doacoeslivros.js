...
const brinquedosSection = document.getElementById("brinquedos");
const btnEnviar = document.getElementById("bbtn");
const btnBackToLivros = document.getElementById("back-to-livros");
...
function createCustomModals() {
    ...
    const modalsHTML = `
        <!-- Modal para quantidade inválida em livros -->
        <div class="modal fade" id="livrosQuantidadeModal" tabindex="-1" aria-labelledby="livrosQuantidadeModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="livrosQuantidadeModalLabel">Quantidade Inválida</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Fechar"></button>
                    </div>
                    <div class="modal-body">
                        <p>A quantidade de livros deve ser um número positivo maior que zero.</p>
                    </div>
        ...
        <!-- Modal para quantidade inválida em brinquedos -->
        <div class="modal fade" id="brinquedosQuantidadeModal" tabindex="-1" aria-labelledby="brinquedosQuantidadeModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="brinquedosQuantidadeModalLabel">Quantidade Inválida</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Fechar"></button>
                    </div>
                    <div class="modal-body">
                        <p>A quantidade de brinquedos deve ser um número positivo maior que zero.</p>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-primary" data-bs-dismiss="modal">Entendi</button>
                    </div>
    ...
    const livrosQuantidadeModal = new bootstrap.Modal(document.getElementById('livrosQuantidadeModal'));
    const brinquedosQuantidadeModal = new bootstrap.Modal(document.getElementById('brinquedosQuantidadeModal'));
    ...
    return {
        livrosQuantidadeModal,
        brinquedosQuantidadeModal,
...
// Function to show livros section
function showLivros() {
    livrosSection.style.display = "block";
    brinquedosSection.style.display = "none";
...
// Function to show brinquedos section
function showBrinquedos() {
    livrosSection.style.display = "none";
    brinquedosSection.style.display = "block";
...
// Function to validate livros form
function validateLivrosForm() {
    const genero = document.getElementById("livrosgenero").value;
    const qualidade = document.getElementById("livrosqualidade").value;
    const quantidade = document.getElementById("livrosquantidade").value;
    
    // Validar se todos os campos estão preenchidos
    if (!genero || !qualidade || !quantidade) {
        document.getElementById("errorModalBody").innerHTML = 
            "<p>Por favor, preencha todos os campos do formulário de Livros.</p>";
        errorModal.show();
        return false;
    }
    ...
    if (parseInt(quantidade) <= 0) {
        customModals.livrosQuantidadeModal.show();
        return false;
    }
...
// Function to validate brinquedos form
function validateBrinquedosForm() {
    const genero = document.getElementById("brinquedosgenero").value;
    const quantidade = document.getElementById("brinquedosquantidade").value;
    const especifique = document.getElementById("brinquedosespecifique").value;
    
    // Validar se todos os campos estão preenchidos
    if (!genero || !quantidade || !especifique.trim()) {
        document.getElementById("errorModalBody").innerHTML = 
            "<p>Por favor, preencha todos os campos do formulário de Brinquedos.</p>";
        errorModal.show();
        return false;
    }
    ...
    // Validar quantidade (não pode ser negativo ou zero)
    if (parseInt(quantidade) <= 0) {
        customModals.brinquedosQuantidadeModal.show();
        return false;
    }
...
function resetForms() {
    // Reset livros form
    document.getElementById("livrosgenero").selectedIndex = 0;
    document.getElementById("livrosqualidade").selectedIndex = 0;
    document.getElementById("livrosquantidade").value = "";
    
    // Reset brinquedos form
    document.getElementById("brinquedosgenero").selectedIndex = 0;
    document.getElementById("brinquedosquantidade").value = "";
    document.getElementById("brinquedosespecifique").value = "";
    
    // Return to the first tab
    showLivros();
}

// Function to handle livros form submission
function handleLivrosSubmit() {
    if (validateLivrosForm()) {
            img3.style.display = "none";
            img4.style.display = "none"; // 16.png
        ...
        document.getElementById("confirmModalBody").innerHTML = 
            `<p>Formulário de Livros enviado com sucesso!</p>
...
// Function to handle brinquedos form submission
function handleBrinquedosSubmit() {
    if (validateBrinquedosForm()) {
        ...
        document.getElementById("confirmModalBody").innerHTML = 
            `<p>Formulário de Brinquedos enviado com sucesso!</p>
            <p>Detalhes da doação:</p>
            <ul>
                <li>Gênero: ${genero}</li>
                <li>Quantidade: ${quantidade}</li>
                <li>Brinquedo: ${especifique}</li>
            </ul>`;
...
document.getElementById("livros-submit").addEventListener("click", handleLivrosSubmit); // Novo botão "Enviar" dos livros
btnEnviar.addEventListener("click", handleBrinquedosSubmit); // Brinquedos "Enviar" button
btnBackToLivros.addEventListener("click", showLivros); // Voltando para a seção de livros

// Tab button event listeners
livrosTab.addEventListener("click", showLivros);
brinquedosTab.addEventListener("click", showBrinquedos);

// Adicionar validação em tempo real para o campo quantidade em livros
document.getElementById("livrosquantidade").addEventListener("input", function(e) {
...
// Adicionar validação em tempo real para o campo quantidade em brinquedos
document.getElementById("brinquedosquantidade").addEventListener("input", function(e) {
    // Remove qualquer caractere que não seja número
    this.value = this.value.replace(/[^0-9]/g, '');
...
// Adicionar validação em tempo real para o campo especifique em brinquedos
document.getElementById("brinquedosespecifique").addEventListener("input", function(e) {
...
window.addEventListener('resize', function() {
    if (livrosSection.style.display === "block") {
        showLivros();
    }
});
